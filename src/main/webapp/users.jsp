        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <a href="/edit-user?id=${user.getId()}" class="btn btn-group">Edit</a>
                        <a href="/delete-user?id=${user.getId()}" class="btn btn-group">Delete</a>
                    </td>
                </tr>
                </c:forEach>
        </div>
        ...
        <ul class="pagination justify-content-center">
            ...
            <c:forEach begin="1" end="${total}" varStatus="loop">
                <li class="page-item"><a class="page-link"
                                         href="/users?page=${loop.index}">${loop.index}</a></li>
            </c:forEach>
        </ul>
    </div>
</c:if>
